...
export const Settings = () => {
    ...
    const onSaveClick = async () => {
        await new TradeService(userCtx.userData.accessToken).SaveAccountSettings(userCtx.userData.settings);
    ...
    return (
        <Card>
            ...
            <Button intent={Intent.PRIMARY} onClick={onSaveClick}>Save</Button>
